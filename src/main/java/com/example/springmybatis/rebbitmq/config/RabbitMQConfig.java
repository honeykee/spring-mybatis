...
//        Channel channel =  connection.createChannel(true );  //true transactional
//

//        connectionFactory.setPublisherConfirms(true);
//        connectionFactory.setPublisherReturns(true);
        System.out.println( "isPublisherConfirms: " + connectionFactory.isPublisherConfirms());
        System.out.println( "isPublisherReturns: " + connectionFactory.isPublisherReturns());

        RabbitTemplate template = new RabbitTemplate(connectionFactory);
         template.setMessageConverter(jsonMessageConverter()); // 可以自定义消息转换器  默认使用的JDK的，所有消息对象需要实现Serializable
